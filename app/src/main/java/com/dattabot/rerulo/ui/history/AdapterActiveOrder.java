...
public class AdapterActiveOrder extends RecyclerView.Adapter {
    private final String TAG = getClass().getSimpleName();

    private Context context;
    private RealmList<Cart> dataList;

    public AdapterActiveOrder(Context context, RealmList<Cart> dataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_active_order_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        itemHolder.tvItems.setText(String.valueOf(data.getProducts().size()));
    ...
    class ItemHolder extends RecyclerView.ViewHolder{
        @BindView(R.id.active_order_tv_store_name)
        TextView tvName;
        @BindView(R.id.active_order_tv_items)
        TextView tvItems;
        @BindView(R.id.active_order_tv_total)
        TextView tvTotal;
        @BindView(R.id.active_order_ll_container)
