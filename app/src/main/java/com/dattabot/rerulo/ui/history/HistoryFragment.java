...
public class HistoryFragment extends Fragment {
    ...
    @BindView(R.id.fragment_history_tb_main_tab)
    TabLayout tbMainTab;
    @BindView(R.id.fragment_history_vp_main)
    ViewPager vpMain;
    ...
    public void onResume() {
        ...
        adapterViewPager.addFragment(finishOrderFragment, "selesai");
        vpMain.setAdapter(adapterViewPager);
        tbMainTab.setupWithViewPager(vpMain);
