...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (realmHelper.getUser() == null) {
            ...
            if (realmHelper.getUser().isLogin()) {
    ...
    private void createDummyData() {
        ...
        RealmResults<Product> productDel = realm.where(Product.class).findAll();
        productDel.deleteAllFromRealm();
        RealmResults<Category> categoryDel = realm.where(Category.class).findAll();
        categoryDel.deleteAllFromRealm();
        RealmResults<Store> storeDel = realm.where(Store.class).findAll();
        storeDel.deleteAllFromRealm();
